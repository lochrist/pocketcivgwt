package com.bbg.client.data;

import java.util.HashMap;
import java.util.Vector;

import com.bbg.client.State.GameEngine;
import com.bbg.client.State.event.Anarchy;
import com.bbg.client.State.event.Bandits;
import com.bbg.client.State.event.CivilWar;
import com.bbg.client.State.event.Corruption;
import com.bbg.client.State.event.Earthquake;
import com.bbg.client.State.event.Epidemic;
import com.bbg.client.State.event.Famine;
import com.bbg.client.State.event.Flood;
import com.bbg.client.State.event.Sandstorm;
import com.bbg.client.State.event.Superstition;
import com.bbg.client.State.event.TribalWar;
import com.bbg.client.State.event.Uprising;
import com.bbg.client.State.event.Visitation;
import com.bbg.client.State.event.Volcano;
